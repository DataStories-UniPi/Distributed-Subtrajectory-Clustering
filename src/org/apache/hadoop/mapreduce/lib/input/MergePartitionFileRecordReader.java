...
public class MergePartitionFileRecordReader<K, V> extends RecordReader<K, V> {

  @SuppressWarnings("rawtypes")
static final Class [] constructorSignature = new Class [] 
                                         {MergePartitionFileSplit.class,
                                          TaskAttemptContext.class,
                                          Integer.class};

  protected MergePartitionFileSplit split;
  ...
  public void initialize(InputSplit split,
    ...
    this.split = (MergePartitionFileSplit)split;
   ...
   */
  public MergePartitionFileRecordReader(MergePartitionFileSplit split,
