...
public class MyMergePartitionFileInputFormat extends MergePartitionFileInputFormat<LongWritable,Text>{

    public static class MyMergePartitionFileRecordReader extends RecordReader<LongWritable,Text>{
        private LineRecordReader delegate=null;
        private int idx;

        public MyMergePartitionFileRecordReader(MergePartitionFileSplit split,TaskAttemptContext taskcontext ,Integer idx) throws IOException {
            this.idx=idx;
        ...
        public void initialize(InputSplit split, TaskAttemptContext taskcontext) throws IOException {
        	MergePartitionFileSplit csplit=(MergePartitionFileSplit)split;
    ...
    public RecordReader<LongWritable,Text> createRecordReader(InputSplit split,TaskAttemptContext taskcontext) throws IOException {
        return new MergePartitionFileRecordReader<LongWritable,Text>((MergePartitionFileSplit) split, taskcontext, MyMergePartitionFileRecordReader.class);
    }
}