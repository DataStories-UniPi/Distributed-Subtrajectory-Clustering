...
public class DTJSubtrajPairSim implements Writable, WritableComparable<DTJSubtrajPairSim> {
	...
	public DTJSubtrajPairSim() {
		
	}

	public DTJSubtrajPairSim(int r_obj_id, int r_traj_id, int r_subtraj_id, int s_obj_id, int s_traj_id, int s_subtraj_id, double sim) {
	...
	public DTJSubtrajPairSim(DTJSubtrajPairSim elem) {
	...
	public String toString() {
		...
		return (new StringBuilder().append(r_obj_id).append(",").append(r_traj_id).append(",").append(r_subtraj_id).append(",").append(s_obj_id).append(",").append(s_traj_id).append(",").append(s_subtraj_id).append(",").append(sim).toString());
	}
	...
	public void write(DataOutput dataOutput) throws IOException {
	 ...
	 @Override
	    public boolean equals(Object o) {
	        ...
	        if (!(o instanceof DTJSubtrajPairSim)) {
	            return false;
	        }

	        DTJSubtrajPairSim pair = (DTJSubtrajPairSim) o;
	...
	public int compareTo(DTJSubtrajPairSim objKeyPair) {
